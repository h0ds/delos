    ...
    <div className="fixed top-20 right-6 z-50">
      <div className="relative">
        ...
        <button
          ...
          className="flex items-center gap-2 px-3 py-2 rounded-lg bg-card/80 border border-border/50 hover:border-primary/50 hover:bg-card transition-all duration-300 group"
        >
